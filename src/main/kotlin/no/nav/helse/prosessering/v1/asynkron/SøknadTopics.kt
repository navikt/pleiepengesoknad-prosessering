        ...
        return data?.let {
            ...
            TopicEntry(
                ...
                EndringsmeldingV1(
                    ...
                    harForståttRettigheterOgPlikter = endringsmeldingMottatt.harForståttRettigheterOgPlikter,
                    k9Format = Søknad.SerDes.deserialize(endringsmeldingMottatt.k9Format)
                )
            )
        }
    }
