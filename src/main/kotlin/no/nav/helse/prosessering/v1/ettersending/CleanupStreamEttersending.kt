...
internal class CleanupStreamEttersending(
    ...
    private companion object {
        ...
        private fun topology(dokumentService: DokumentService): Topology {
            ...
            val fraCleanup: Topic<TopicEntry<CleanupEttersending>> = Topics.ETTERSENDING_CLEANUP
            val tilJournalført: Topic<TopicEntry<JournalførtEttersending>> = Topics.ETTERSENDING_JOURNALFORT

            builder
                .stream(fraCleanup.name, Consumed.with(fraCleanup.keySerde, fraCleanup.valueSerde))
