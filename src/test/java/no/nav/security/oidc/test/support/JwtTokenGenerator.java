...
public class JwtTokenGenerator {
    ...
    public static SignedJWT createSignedJWT(String subject, long expiryInMinutes) {
        JWTClaimsSet claimsSet = buildClaimSet(subject, ISS, AUD, TimeUnit.MINUTES.toMillis(expiryInMinutes));
    ...
    public static JWTClaimsSet buildClaimSet(String subject, String issuer, String audience, long expiry) {
        Date now = new Date();
